import{ab as p,G as e,H as o,E as n,S as s,N as c,ac as a,W as l}from"./framework-11534bf9.js";const i={},u=a('<h1 id="vue中8种组件通信方式" tabindex="-1"><a class="header-anchor" href="#vue中8种组件通信方式" aria-hidden="true">#</a> Vue中8种组件通信方式</h1><h2 id="_1-简介" tabindex="-1"><a class="header-anchor" href="#_1-简介" aria-hidden="true">#</a> 1. 简介</h2><p>vue是数据驱动视图更新的框架, 所以对于vue来说组件间的数据通信非常重要，那么组件之间如何进行数据通信的呢？</p><figure><img src="https://zszblog.oss-cn-beijing.aliyuncs.com/zszblog/blogimage-master/image-20210608202150893.png" alt="image-20210608202150893" tabindex="0" loading="lazy"><figcaption>image-20210608202150893</figcaption></figure><p>如上图所示, A与B、A与C、B与D、C与E组件之间是父子关系； B与C之间是兄弟关系；A与D、A与E之间是隔代关系； D与E是堂兄关系（非直系亲属） 针对以上关系我们归类为：</p><ul><li>父子组件之间通信</li><li>非父子组件之间通信(兄弟组件、隔代关系组件等)</li></ul><h3 id="_8种方式" tabindex="-1"><a class="header-anchor" href="#_8种方式" aria-hidden="true">#</a> 8种方式</h3>',7),r=n("ol",null,[n("li",null,"props/ $emit"),n("li",null,"$children/ $parent"),n("li",null,"provide/ reject"),n("li",null,"ref"),n("li",null,"eventBus"),n("li",null,"Vuex"),n("li",null,"localstorage/ sessionstorage"),n("li",null,[n("span",{class:"katex"},[n("span",{class:"katex-mathml"},[n("math",{xmlns:"http://www.w3.org/1998/Math/MathML"},[n("semantics",null,[n("mrow",null,[n("mi",null,"a"),n("mi",null,"t"),n("mi",null,"r"),n("mi",null,"s"),n("mtext",null,"与"),n("mi",null,"s")]),n("annotation",{encoding:"application/x-tex"},"atrs与s")])])]),n("span",{class:"katex-html","aria-hidden":"true"},[n("span",{class:"base"},[n("span",{class:"strut",style:{height:"0.6833em"}}),n("span",{class:"mord mathnormal"},"a"),n("span",{class:"mord mathnormal"},"t"),n("span",{class:"mord mathnormal"},"rs"),n("span",{class:"mord cjk_fallback"},"与"),n("span",{class:"mord mathnormal"},"s")])])]),s(" Listeners")])],-1),d=a(`<h2 id="_2-组件通信8种方式" tabindex="-1"><a class="header-anchor" href="#_2-组件通信8种方式" aria-hidden="true">#</a> 2. 组件通信8种方式</h2><h3 id="_2-1-方式1-props-emit" tabindex="-1"><a class="header-anchor" href="#_2-1-方式1-props-emit" aria-hidden="true">#</a> 2.1 方式1：props/ $emit</h3><p>父组件通过<code>props</code>的方式向子组件传递数据，而通过<code>$emit</code> 子组件可以向父组件通信。</p><h4 id="_2-1-1-父组件向子组件传值" tabindex="-1"><a class="header-anchor" href="#_2-1-1-父组件向子组件传值" aria-hidden="true">#</a> 2.1.1 父组件向子组件传值</h4><p>下面通过一个例子说明父组件如何向子组件传递数据：在子组件<code>article.vue</code>中如何获取父组件<code>section.vue</code>中的数据<code>articles:[&#39;红楼梦&#39;, &#39;西游记&#39;,&#39;三国演义&#39;]</code></p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// section父组件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-总结" tabindex="-1"><a class="header-anchor" href="#_3-总结" aria-hidden="true">#</a> 3. 总结</h2><p>常见使用场景可以分为三类:</p><ul><li>父子组件通信: <code>props</code>; <code>$parent</code> / <code>$children</code>; <code>provide</code> / <code>inject</code> ; <code>ref</code> ; <code>$attrs</code> / <code>$listeners</code></li><li>兄弟组件通信: <code>eventBus</code> ; vuex</li><li>跨级通信: <code>eventBus</code>；Vuex；<code>provide</code> / <code>inject</code> 、<code>$attrs</code> / <code>$listeners</code></li></ul><h2 id="参考文章" tabindex="-1"><a class="header-anchor" href="#参考文章" aria-hidden="true">#</a> 参考文章</h2>`,76),k={href:"https://juejin.cn/post/6844903887162310669#heading-20",target:"_blank",rel:"noopener noreferrer"};function v(m,g){const t=l("ExternalLinkIcon");return e(),o("div",null,[u,r,d,n("p",null,[n("a",k,[s("vue中8种组件通信方式, 值得收藏!"),c(t)])])])}const h=p(i,[["render",v],["__file","vue-component-communication.html.vue"]]);export{h as default};
