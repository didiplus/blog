import{ab as n,G as i,H as e,ad as s}from"./framework-b31a425c.js";const l={},d=s(`<h1 id="线程池使用示例" tabindex="-1"><a class="header-anchor" href="#线程池使用示例" aria-hidden="true">#</a> 线程池使用示例</h1><p>具体使用示例</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public class Test {
