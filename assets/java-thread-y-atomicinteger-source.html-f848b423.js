import{ab as a,G as e,H as t,E as n,S as p,N as c,ad as o,W as l}from"./framework-b31a425c.js";const i={},u=o(`<h1 id="原子类atomicinteger源码解析" tabindex="-1"><a class="header-anchor" href="#原子类atomicinteger源码解析" aria-hidden="true">#</a> 原子类AtomicInteger源码解析</h1><h2 id="_1-核心原理" tabindex="-1"><a class="header-anchor" href="#_1-核心原理" aria-hidden="true">#</a> 1. 核心原理</h2><h3 id="_1-1-操作对象value" tabindex="-1"><a class="header-anchor" href="#_1-1-操作对象value" aria-hidden="true">#</a> 1.1 操作对象value</h3><p>AtomicInteger用于实现通过原子的方式更新单个变量。AtomicInteger 中保存了一个核心字段value，它就代表了Atomiclnteger 的当前实际取值，所有的方法都是围绕该值进行的。</p><h3 id="_1-2-偏移量valueoffset" tabindex="-1"><a class="header-anchor" href="#_1-2-偏移量valueoffset" aria-hidden="true">#</a> 1.2 <strong>偏移量</strong>valueOffset</h3><p><strong>属性valueOffset，它保存着value 字段在Atomiclnteger 对象中的偏移量。Unsafe中的CAS方法都是通过字段的偏移量来操作字段的。</strong></p><h2 id="_2-初始代码" tabindex="-1"><a class="header-anchor" href="#_2-初始代码" aria-hidden="true">#</a> 2. 初始代码</h2><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
