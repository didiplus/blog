...
* 初始化容器不支持 [就绪检查 readiness probe](pod-lifecycle.md#container-probes)，因为初始化容器必须在 Pod ready 之前运行并结束
...
![Kubernetes教程：在Kuboard中使用初始化容器](https://didiplus.oss-cn-hangzhou.aliyuncs.com/image-20190907171451988.e6541888.png)
