...
* [01.部署第一个应用程序](./deploy-app.md) 5分钟
...
![Kubernetes集群](https://kuboard.cn/assets/img/module_01.f6dc9f93.svg)


上图描述的是拥有一个Master(主)节点和六个Worker(工作)节点的k8s集群

![Kubernetes教程：学习Kubernetes基础知识](https://kuboard.cn/assets/img/module_01_cluster.8f54b2c5.svg)
...
~~let‘s go-> [部署第一个应用程序](./deploy-app.md)
