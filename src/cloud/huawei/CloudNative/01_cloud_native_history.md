...
![](https://didiplus.oss-cn-hangzhou.aliyuncs.com/20230227101655.png)
...
![](https://didiplus.oss-cn-hangzhou.aliyuncs.com/20230227101759.png)

K8s的出现带动了云原生生态的蓬勃发展，在整个IT技术发展史上也是颇具突破性的。

从2015年CNCF只有Kubernetes一个项目，到了到如今80多个官方项目，以及整个云原生生生态内容丰富的宏大版图。

![](https://didiplus.oss-cn-hangzhou.aliyuncs.com/20230227101824.png)
...
超过250家认证服务商和培训合作伙伴提供丰富的周边软件。



而在中国，云原生的生态也飞速发展，CNCF的会员数量.

![](https://didiplus.oss-cn-hangzhou.aliyuncs.com/20230227101903.png)
...
![](https://didiplus.oss-cn-hangzhou.aliyuncs.com/20230227102016.png)
...
- 趋势3 ：有状态应用向云原生迁移：无状态+Job类应用趋于成熟，有状态应用逐步成为云原生市场中新的增长点。Operator 的出现，为有状态应用在云原生基础设施上运行提供一套行之有效的标准规范，降低了使用门槛，使有状态应用得以真正发展。
...
![](https://didiplus.oss-cn-hangzhou.aliyuncs.com/20230227102144.png)
...
![](https://didiplus.oss-cn-hangzhou.aliyuncs.com/20230227102229.png)
...
![](https://didiplus.oss-cn-hangzhou.aliyuncs.com/20230227102351.png)
...
![](https://didiplus.oss-cn-hangzhou.aliyuncs.com/20230227102410.png)

云原生的技术版图

![](https://didiplus.oss-cn-hangzhou.aliyuncs.com/20230227102434.png)

CNCF的项目成熟度模型

![](https://didiplus.oss-cn-hangzhou.aliyuncs.com/20230227102458.png)
...
3. **毕业级**：并不意味着项目的停滞，相反来说项目的成熟度达到了巅峰的水平，业界有非常多的用户在大规模落地和使用，其社区生态也呈现了非常活跃，多元化的态势。对于很多保守的4. **企业或采用者**。可以放心的去落地使用或者跟进这个开源项目。
...
![](https://didiplus.oss-cn-hangzhou.aliyuncs.com/20230227102650.png)
