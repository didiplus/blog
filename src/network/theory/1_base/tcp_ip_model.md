...
![](https://didiplus.oss-cn-hangzhou.aliyuncs.com/%E5%BA%94%E7%94%A8%E5%B1%82.png)
...
![](https://didiplus.oss-cn-hangzhou.aliyuncs.com/TCPSegment.png)
...
![](https://didiplus.oss-cn-hangzhou.aliyuncs.com/network.png)

网络层最常使用的是 IP 协议（*Internet Protocol*），IP 协议会将传输层的报文作为数据部分，再加上 IP 包头组装成 IP 报文，如果 IP 报文大小超过 MTU（以太网中一般为 1500 字节）就会**再次进行分片**，得到一个即将发送到网络的 IP 报文。

![](https://didiplus.oss-cn-hangzhou.aliyuncs.com/12.jpg)
...
![子网掩码计算器](https://didiplus.oss-cn-hangzhou.aliyuncs.com/subnet.png)
...
![IP地址的网络号](https://didiplus.oss-cn-hangzhou.aliyuncs.com/17.jpg)
...
![](https://didiplus.oss-cn-hangzhou.aliyuncs.com/network1.png)
...
![](https://didiplus.oss-cn-hangzhou.aliyuncs.com/tcpip.png)

再给大家贴一下每一层的封装格式：
![](https://didiplus.oss-cn-hangzhou.aliyuncs.com/fengzhuang.png)
